...
WHERE TR.[TypeCode] = 'control' AND 
	(
		 R.[SampleId] LIKE 'Val-%' OR
		 R.[SampleId] LIKE 'VAL-%' OR
		 R.[SampleId] LIKE '%validation%' OR
		 R.[SampleId] LIKE '%Validation%'
...
WHERE
	(
		 R1.[SampleId] LIKE 'Val-%' OR
		 R1.[SampleId] LIKE 'VAL-%' OR
		 R1.[SampleId] LIKE '%validation%' OR
		 R1.[SampleId] LIKE '%Validation%'
