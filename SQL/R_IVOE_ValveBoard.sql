...
WHERE P.[PartNumber] LIKE 'FLM%-ASY-0001' AND UP.[PartNumber] LIKE 'FLM%-SUB-0013' AND UPP.[PartNumber] LIKE 'PCBA-SUB-0847' AND UPP.[Quantity] > 0 AND ULLL.[LotNumber] NOT LIKE 'N/A'
GROUP BY
	L.[LotNumber],
	UPP.[PartNumber],
	ULLL.[LotNumber],
...
WHERE P.[PartNumber] LIKE 'PCBA-SUB-0847'
...
(
	...
	WHERE [Part Affected] LIKE 'PCBA-SUB-0847'
) T
GROUP BY [LotNumber]
...
(
	...
	WHERE [Part Used] LIKE 'PCBA-SUB-0847'
) P
