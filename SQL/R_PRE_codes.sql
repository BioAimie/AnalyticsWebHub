...
SELECT 
	b.[bug_id],
	CONVERT(CHAR(7), b.[creation_ts], 120) AS [CreatedDate],
...
WHERE ([comments] LIKE '%z1%' OR [comments] LIKE '%z2%' OR [comments] LIKE '%z3%') AND [comments] IS NOT NULL AND [creation_ts] > '2016-01-01'

SELECT
	[CreatedDate],
	CASE
		WHEN [Code] = 'z101' THEN 'Sufficient info: Investigation started.'
