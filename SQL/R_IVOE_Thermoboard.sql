...
WHERE P.[PartNumber] LIKE 'FLM%-ASY-0001' AND UP.[PartNumber] LIKE 'FLM%-SUB-0013' AND UPP.[PartNumber] LIKE 'PCBA-SUB-0836' AND UPP.[Quantity] > 0 AND ULLL.[LotNumber] NOT LIKE 'N/A'
...
(
	...
	WHERE [Part Used] LIKE 'PCBA-SUB-0836'
) P
