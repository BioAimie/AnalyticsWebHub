...
WHERE P.[PartNumber] IN ('FLM1-ASY-0001','FLM2-ASY-0001','HTFA-ASY-0003','FLM2-ASY-0001R','HTFA-ASY-0003R','HTFA-SUB-0103','HTFA-SUB-0103R')
...
WHERE P.[PartNumber] = 'PCBA-SUB-0839'
...
(
	...
	WHERE [Part Affected] = 'PCBA-SUB-0839'
) T
GROUP BY [LotNumber]
