...
SELECT
	...
	UPP.[PartNumber],
	SUBSTRING(ULLLL.[LotNumber], 1, CHARINDEX('.', ULLLL.[LotNumber],1)-1) AS [LotNumber],
	ULLLL.[ActualLotSize]
INTO #pcbaLotsInProd
...
WHERE P.[PartNumber] LIKE 'FLM%-ASY-0001' AND UP.[PartNumber] LIKE 'FLM%-SUB-0013' AND UPP.[PartNumber] LIKE 'FLM2-SUB-0064' AND UPPP.[PartNumber] LIKE 'PCBA-SUB-0838' AND UPP.[Quantity] > 0 AND ULLL.[LotNumber] NOT LIKE 'N/A'
...
WHERE P.[PartNumber] LIKE 'PCBA-SUB-0838'
...
(
	...
	WHERE [Part Used] LIKE 'PCBA-SUB-0838'
) P
