...
p.hydra.wsw.lsd.one <- ggplot(hydration.imr.lsd.wsw[as.character(hydration.imr.lsd.wsw[,'Equipment']) %in% c('Pouch Line-1','Pouch Line-2'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Water Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.wsw.lsd.two <- ggplot(hydration.imr.lsd.wsw[as.character(hydration.imr.lsd.wsw[,'Equipment']) %in% c('Pouch Line-3','Pouch Line-4'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Water Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.wsw.lsd.three <- ggplot(hydration.imr.lsd.wsw[as.character(hydration.imr.lsd.wsw[,'Equipment']) %in% c('Pouch Line-5','Pouch Line-6'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Water Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.wsw.lsd.four <- ggplot(hydration.imr.lsd.wsw[as.character(hydration.imr.lsd.wsw[,'Equipment']) %in% c('Pouch Line-7','Pouch Line-8'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Water Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.ssw.lsd.one <- ggplot(hydration.imr.lsd.ssw[as.character(hydration.imr.lsd.ssw[,'Equipment']) %in% c('Pouch Line-1','Pouch Line-2'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Sample Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.ssw.lsd.two <- ggplot(hydration.imr.lsd.ssw[as.character(hydration.imr.lsd.ssw[,'Equipment']) %in% c('Pouch Line-3','Pouch Line-4'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Sample Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.ssw.lsd.three <- ggplot(hydration.imr.lsd.ssw[as.character(hydration.imr.lsd.ssw[,'Equipment']) %in% c('Pouch Line-5','Pouch Line-6'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Sample Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
p.hydra.ssw.lsd.four <- ggplot(hydration.imr.lsd.ssw[as.character(hydration.imr.lsd.ssw[,'Equipment']) %in% c('Pouch Line-7','Pouch Line-8'),], aes(x=Observation, y=Result, group='1')) + geom_line() + geom_point() + facet_grid(Key~Equipment, scales='free') + geom_hline(aes(yintercept=LCL), color='darkgreen') + geom_hline(aes(yintercept=UCL), color='darkgreen') + geom_hline(aes(yintercept=Average), color='blue') + theme(plot.title=element_text(size=fontSize, face=fontFace), text=element_text(size=fontSize, face=fontFace), axis.text=element_text(size=fontSize, face=fontFace, color='black')) + scale_x_continuous(labels = function(x) floor(x)) + labs(title='Hydration Testing by Line - Sample Side Weight\n (Last 7 Days of Manufacturing)', y='Result (FYI limits include all historical data)')
...
startDate <- findStartDate(calendar.df, 'Week', 53)
