...
p.panel.runs.cumulative <- ggplot(panel.runs.cumulative.sites, aes(x=DateGroup, y=Record.x, fill=as.factor(Record.y))) + geom_bar(stat='identity') + facet_wrap(~Panel, scale='free_y') + scale_x_discrete(breaks = date.groups.month) + theme(panel.background=element_rect(color='white', fill='white'),plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1)) + scale_fill_manual(values=createPaletteOfVariableLength(panel.runs.cumulative.sites, 'Record.y', TRUE), name='Contributing\nSites') + labs(title='Cumulative Total Run Count at Participating Trend Sites by Panel', y='Cumulative Run Count', x='Year-Month')
...
p.panel.runs <- ggplot(panel.runs.fill.sites, aes(x=DateGroup, y=Record.x, fill=as.factor(Record.y))) + geom_bar(stat='identity') + facet_wrap(~Panel, scale='free_y') + scale_x_discrete(breaks = date.groups.month) + theme(panel.background=element_rect(color='white', fill='white'), plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1)) + scale_fill_manual(values=createPaletteOfVariableLength(panel.runs.cumulative.sites, 'Record.y', TRUE), name='Contributing\nSites') + labs(title='Run Count at Participating Trend Sites by Panel', y='Monthly Run Count', x='Year-Month')
...
p.rp.prev.pareto <- ggplot(rp.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=rp.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(panel.background=element_rect(color='white',fill='white'),plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Organism Prevalence in RP Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.gi.prev.pareto <- ggplot(gi.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=gi.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(panel.background=element_rect(color='white',fill='white'),plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Organism Prevalence in GI Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
# p.me.prev.pareto <- ggplot(me.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=me.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(panel.background=element_rect(color='white',fill='white'),plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Organism Prevalence in ME Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.bcid.prev.pareto <- ggplot(bcid.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=bcid.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(panel.background=element_rect(color='white',fill='white'),plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=70, hjust=1, size=16)) + labs(title='Organism Prevalence in BCID Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.bcid.prev.gene.pareto <- ggplot(bcid.gene.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=bcid.gene.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(panel.background=element_rect(color='white',fill='white'),plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Gene Prevalence in BCID Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
