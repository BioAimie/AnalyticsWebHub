...
p.panel.runs.cumulative <- ggplot(panel.runs.cumulative.sites, aes(x=DateGroup, y=Record.x, fill=as.factor(Record.y))) + geom_bar(stat='identity') + facet_wrap(~Panel, scale='free_y') + scale_x_discrete(breaks = date.groups.month) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1)) + scale_fill_manual(values=createPaletteOfVariableLength(panel.runs.cumulative.sites, 'Record.y', TRUE), name='Contributing\nSites') + labs(title='Cumulative Total Run Count at Participating Trend Sites by Panel', y='Cumulative Run Count', x='Year-Month')
...
p.panel.runs <- ggplot(panel.runs.fill.sites, aes(x=DateGroup, y=Record.x, fill=as.factor(Record.y))) + geom_bar(stat='identity') + facet_wrap(~Panel, scale='free_y') + scale_x_discrete(breaks = date.groups.month) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1)) + scale_fill_manual(values=createPaletteOfVariableLength(panel.runs.cumulative.sites, 'Record.y', TRUE), name='Contributing\nSites') + labs(title='Run Count at Participating Trend Sites by Panel', y='Monthly Run Count', x='Year-Month')

# # data contribution by site - COMMENT OUT BECAUSE THIS CANNOT BE ON THE WEBHUB
# p.rp.runs.site <- ggplot(subset(runs.month, Panel=='RP'), aes(x=DateGroup, y=Record, fill=Panel)) + geom_bar(stat='identity') + facet_wrap(~CustomerSiteId, scales='free_y') + scale_fill_manual(values=createPaletteOfVariableLength(subset(runs.month, Panel=='RP'), 'Panel'), guide=FALSE) + scale_x_discrete(breaks = date.groups.month) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1)) + labs(title='Run Count of RP Panel at Participating Trend Sites', y='Monthly Run Count', x='Year-Month')
...
p.rp.season.overlay <- ggplot(subset(rp.runs.norm.nat, SeasonYear > 2012), aes(x=SeasonWeek, y=NormalizedBurn, group=Season, color=Season)) + geom_line(size=1.5) + scale_color_manual(values=pal.season.overlay, name='Respiratory Season') + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, color='black', face='bold')) + scale_x_continuous(breaks=seq(1, 53, 4)) + labs(title='Normalized RP Burn Rate at Trend Sites', x='Season Week', y='Normalized Burn Rate')
...
p.rp.prev.trend <- ggplot(rp.prev.wrap[with(rp.prev.wrap, order(ShortName, decreasing=TRUE)), ], aes(x=YearWeek)) + geom_area(aes(y=Prevalence, group=ShortName, fill=ShortName, order=ShortName)) + scale_fill_manual(values=createPaletteOfVariableLength(rp.prev.wrap,'ShortName'), name='') + scale_y_continuous(labels=percent) + scale_x_discrete(breaks = as.character(unique(rp.prev.wrap$YearWeek))[order(as.character(unique(rp.prev.wrap$YearWeek)))][seq(1, length(as.character(unique(rp.prev.wrap$YearWeek))), 8)]) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1, vjust=0.5), legend.position='bottom') + labs(title='Percent Detection of Organisms in RP Tests', x='Year-Week', y='Percent Detection')
...
p.rp.prev.pareto <- ggplot(rp.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=rp.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Organism Prevalence in RP Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.gi.prev.trend <- ggplot(gi.prev.wrap[with(gi.prev.wrap, order(ShortName, decreasing=TRUE)), ], aes(x=YearWeek)) + geom_area(aes(y=Prevalence, group=ShortName, fill=ShortName, order=ShortName)) + scale_fill_manual(values=createPaletteOfVariableLength(gi.prev.wrap,'ShortName'), name='') + scale_y_continuous(labels=percent) + scale_x_discrete(breaks = as.character(unique(gi.prev.wrap$YearWeek))[order(as.character(unique(gi.prev.wrap$YearWeek)))][seq(1, length(as.character(unique(gi.prev.wrap$YearWeek))), 8)]) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1, vjust=0.5), legend.position='bottom') + labs(title='Percent Detection of Organisms in GI Tests', x='Year-Week', y='Percent Detection')
...
p.gi.prev.pareto <- ggplot(gi.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=gi.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Organism Prevalence in GI Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
# p.me.prev.trend <- ggplot(me.prev.wrap[with(me.prev.wrap, order(ShortName, decreasing=TRUE)), ], aes(x=YearWeek)) + geom_area(aes(y=Prevalence, group=ShortName, fill=ShortName, order=ShortName)) + scale_fill_manual(values=createPaletteOfVariableLength(me.prev.wrap,'ShortName'), name='') + scale_y_continuous(labels=percent) + scale_x_discrete(breaks = as.character(unique(me.prev.wrap$YearWeek))[order(as.character(unique(me.prev.wrap$YearWeek)))][seq(1, length(as.character(unique(me.prev.wrap$YearWeek))), 8)]) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1, vjust=0.5), legend.position='bottom') + labs(title='Percent Detection of Organisms in ME Tests', x='Year-Week', y='Percent Detection')
...
# p.me.prev.pareto <- ggplot(me.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=me.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Organism Prevalence in ME Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.bcid.prev.trend <- ggplot(bcid.prev.wrap[with(bcid.prev.wrap, order(ShortName, decreasing=TRUE)), ], aes(x=YearWeek)) + geom_area(aes(y=Prevalence, group=ShortName, fill=ShortName, order=ShortName)) + scale_fill_manual(values=createPaletteOfVariableLength(bcid.prev.wrap,'ShortName'), name='') + scale_y_continuous(labels=percent) + scale_x_discrete(breaks = as.character(unique(bcid.prev.wrap$YearWeek))[order(as.character(unique(bcid.prev.wrap$YearWeek)))][seq(1, length(as.character(unique(bcid.prev.wrap$YearWeek))), 8)]) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=90, hjust=1, vjust=0.5), legend.position='bottom') + labs(title='Percent Detection of Organisms in BCID Tests', x='Year-Week', y='Percent Detection')
...
p.bcid.prev.pareto <- ggplot(bcid.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=bcid.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=70, hjust=1, size=16)) + labs(title='Organism Prevalence in BCID Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.bcid.prev.gene.pareto <- ggplot(bcid.gene.prev.pareto, aes(x=Name, y=Prevalence, fill='Bug')) + geom_bar(stat='identity') + geom_text(aes(x=Name, y=Prevalence+0.01, label=paste(round(Prevalence,3)*100, '%', sep='')), data=bcid.gene.prev.pareto) + scale_fill_manual(values = createPaletteOfVariableLength(data.frame(Key='Bug'), 'Key'), guide=FALSE) + scale_y_continuous(labels=percent) + theme(plot.title=element_text(hjust=0.5),text=element_text(size=20, face='bold'), axis.text=element_text(size=20, face='bold', color='black'), axis.text.x=element_text(angle=60, hjust=1)) + labs(title='Gene Prevalence in BCID Tests\n(Last 16 Weeks)', x='', y='Percent Detection')
...
p.site.map <- ggplot(map.sites.us) + geom_map(map=us, aes(x=long, y=lat, map_id=region), fill='white', color='white', size=0.5) + geom_map(data=map.sites.us, map=us, aes(fill=Color, map_id=region), color='white', size=0.5) + scale_fill_manual(values=map.pal, name='Site Count') + theme(plot.title=element_text(hjust=0.5),panel.border=element_blank(), panel.background=element_blank(), axis.ticks=element_blank(), axis.text=element_blank(), text=element_text(size=22, face='bold')) + labs(title='Map of FilmArray Trend Participating Sites', x='',y='')
